...
//    private static final String mt_android_detail= "/Users/jason/Documents/数据处理/详情页/mt-android-详情页.xlsx";
    private static final String mt_android_list = "/Users/jason/Documents/数据处理/列表页/mt-安卓-列表页.xlsx";
    private static final String mt_ios_detail = "";
    private static final String mt_ios_list = "";

//    private static final String mt_android_deatil_process = "/Users/jason/Documents/process/mt_android_detail";
    private static final String mt_android_list_process = "/Users/jason/Documents/process/mt_android_list";
...
//            if(!item.getFromPage().equalsIgnoreCase(mt_android_identify) || item.getLoadTimeModel() == null) {
            if(item.getLoadTimeModel() == null || item.getLoadTimeModel().getVal_load_time()<1) {
               continue;
            }
            rst.add(item);
        }
